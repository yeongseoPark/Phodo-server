...
const user_part2 =  ` || 보고서 상세 작성 지침 : 보고서의 형식은 다음과 같아야 합니다: "1. 서론" "2. 본문", "3. 결론". 앞서 제공된 출처들을 기반으로, 적절한 시간순으로 해당 작업들의 흐름을 보고서에서 정리하세요. 최종 보고서 초안을 작성해주세요. "보고서 작성 과정"이 아닌, "완성된 보고서" 를 응답해주세요`;
